...
Сборка под **Minecraft 1.21.1 + NeoForge** с атмосферным хоррором **Ambient Dread**.
...
Версия 1.4.3: новые звуки и эффекты окружения, реакция на темноту и глубину.
Если ставил 1.4.2 — удали старый jar, две версии одного мода вместе не запустятся.
...
2. Скачай [`mods/ambientdread-1.4.3.jar`](mods/ambientdread-1.4.3.jar).
